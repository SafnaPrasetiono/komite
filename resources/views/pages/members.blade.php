...
<div class="alert-info pt-5 pb-4">
    <div class="container pt-3 pb-4">
        <div class="d-block mb-3">
            ...
            <p class="mb-0 text-secondary">Berikut ini merupakan member KOPITU</p>
        </div>
        <div class="d-block mb-3">
    ...
    <div class="container">
        ...
        <div class="row justify-content-center align-items-center mb-4">
            <div class="col-10 col-md-8 col-lg-6">
                <img src="{{ url('/images/elements/kopituCartSilver.png') }}" alt="about-logo" class="img-fluid">
            </div>
            <div class="col-12 col-lg-6">
                <h3 class="fw-bold">KOPITU SILVER</h3>
                <hr class="soft" style="width: 100px">
                <p class="text-capitalize">Merupakan keanggotaan bagi para Pelaku UMKM yang Memiliki Produk. Jenis kartu
                ...
                <a href="#" class="btn btn-outline-secondary rounded-0 px-5">Daftar</a>
            </div>
        </div>
        <div class="row justify-content-center align-items-center">
            <div class="col-12 col-lg-6 order-2 order-lg-1">
                ...
                <hr class="soft" style="width: 100px">
                <p class="text-capitalize">Merupakan keanggotaan bagi para Pelaku UMKM yang Memiliki Produk dan IUMK.
                    Biaya Rp. 500.000,- (Simpanan Wajib Rp.300.000,-/Tahun, Simpanan Pokok Koperasi Rp.75.000,- & Kartu
                ...
                <a href="#" class="btn btn-outline-warning rounded-0 px-5">Daftar</a>
            </div>
            <div class="col-10 col-md-8 col-lg-6 order-1 order-lg-2">
                <img src="{{ url('/images/elements/kopituCartGold.png') }}" alt="about-kopitu" class="img-fluid">
            </div>
        </div>
        <div class="row justify-content-center align-items-center mb-4">
            <div class="col-10 col-md-8 col-lg-6">
                <img src="{{ url('/images/elements/kopituCartPlatinum.png') }}" alt="about-logo" class="img-fluid">
            </div>
            <div class="col-12 col-lg-6">
                <h3 class="fw-bold">KOPITU PLATINUM</h3>
                <hr class="soft" style="width: 100px">
                <p class="text-capitalize">Merupakan Pelaku UKM/Koperasi/Perusahaan yang ingin berkerjasama atau sudah
                    memiliki perjanjian MOU dengan pihak KOPITU dan sudah memiliki Akta Notaris.</p>
                <p class="text-capitalize">Bisa mengikuti pelatihan MD BPOM & Pendampingan sertifikat produk halal, di
                ...
                <a href="#" class="btn btn-outline-primary rounded-0 px-5">Daftar</a>
            </div>
        </div>
    </div>
</div>
