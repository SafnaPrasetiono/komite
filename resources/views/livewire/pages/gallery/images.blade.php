<div>
    <div class="row g-3">
        ...
        <div class="col-6 col-md-4 col-lg-3">
            <div class="ratio btn-img" wire:click='show({{ $items->id_galleries }}, {{ $numbers }})'>
                <div class="img-gallery" style="background-image: url('/images/galleries/{{$items->location}}')"></div>
            </div>
        </div>
        @endforeach
    </div>
