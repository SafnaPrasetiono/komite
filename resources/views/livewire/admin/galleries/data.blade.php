		...
		<table class="table table-borderless">
			...
			<tbody>
				...
				<tr>
					...
					<td>{{ date('d', strtotime($item->date_start)) }} - {{ date('d F Y', strtotime($item->date_end)) }}</td>
					<td>
						<a href="{{ route('admin.gallery.update', ['id' => $item->id_galleries_contents]) }}" class="btn btn-warning btn-sm text-white">
